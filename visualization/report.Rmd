...
respondent <- read.xls("LND_data_2.xlsx", sheet = 1, header = TRUE)
connections <- read.xls("LND_data_2.xlsx", sheet = 2, header = TRUE)
network <- read.xls("LND_data_2.xlsx", sheet = 3, header = TRUE, na.strings=c("NA",""))
```
